...
import PublicSurveyViewer from './pages/PublicSurveyViewer.jsx';
...
export default function App() {
  ...
  return (
    <Routes>
      {/* Pública (sin login): visualizador de encuestas del constructor */}
      <Route path="/encuesta" element={<PublicSurveyViewer />} />
      {!user ? (
